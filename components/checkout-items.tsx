...
const CheckoutItem = () => {
    ...
    return (
        <div className="px-[75px] mt-[36px] ">
            {/* home to cart */}
            <div className="w-[200px] flex items-center justify-between py-2">
                <Link href="/">
            ...
            <div className=" mt-[26px] ">
                <div className="flex flex-col  justify-start gap-y-3 px-[24px] ">
                    <p className="font-openSans font-bold text-[31px] leading-[42px] ">Checkout</p>
                    <p className="font-openSans font-normal text-[24px] leading-[34px] text-[#4B4C52] ">Select your preferred payment method</p>
                </div>
            </div>
            ...
            <div className="px-[24px] py-[48px] ">
                <div className="w-full grid grid-cols-3">
                    ...
                    <div className="flex flex-col justify-start col-span-1 text-black font-openSans  pl-[50px] ">
